## Поправка 19.0.2.0.2
Добавеното поле hm_description има отделен надпис Item Description / Наименование / описание, за да не дублира надписа Description на стандартното name. Запазена е поправката на PDF заглавието от 19.0.2.0.1.
